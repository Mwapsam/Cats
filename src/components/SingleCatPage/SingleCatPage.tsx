...
const SingleCatPage = () => {
  ...
  const renderStarRating = (rating: number) => {
    ...
    for (let i = 0; i < fullStars; i++) {
      starArray.push(<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star-fill text-warning" viewBox="0 0 16 16">
    ...
    if (halfStars) {
      starArray.push(<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star-half text-warning" viewBox="0 0 16 16">
